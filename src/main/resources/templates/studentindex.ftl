    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <#if role=="1"||role=="3">
                <li>
                    <a href="href="/sports/charts?path=chartManager""><i class="fa fa-bar-chart-o"></i>图表</a>
                </li>
                </#if>
                <#if role=="2">
                <li>
    ...
    <div id="page-wrapper">
        <div id="page-inner">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-header">
                        <p> 您的成绩为：${result.grade}</p>
                        <p> 您的专业排名为：${result.major}</p>
                        <p> 您的学院排名为：${result.college}</p>
                    </h1>
        ...
        $.ajax({
            ...
            success: function(data){
                if(data.success==false){
                    $("#message_area").val("无内容")
                }else{
                    $("#message_area").val(data.data)
                }
            }
        });
    })
