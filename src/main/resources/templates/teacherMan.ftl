    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                    <a class="active-menu" href="/sports/teacher?path=teacherMan"><i class="fa fa-desktop"></i> 老师管理</a>
                </li>
                </#if>
                <#if role=="1"||role=="3">
                <li>
                ...
                <#if role=="1">
                <li>
                    <a href="/sports/insertGrade?path=gradeinsert"><i class="fa fa-table"></i>成绩录入</a>
                </li>
                </#if>
                <#if role=="3">
                <li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            教师信息<input id="btn_add" class="btn btn-small btn-primary" style="float:right" type="button" value="添加"/>
                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td>${teacher.major}</td>
                                        <td><button class="btn-primary" value="${teacher.id}" onclick='deleteTeacher("${teacher.id}")'>删除</button></td>
                                    </tr>
                                    </#list>
                                    </tbody>
                                </table>
